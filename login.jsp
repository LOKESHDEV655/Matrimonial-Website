  ...
  <div class="container">
   ...
   <div class="services">
   	  <div class="col-sm-6 login_left">
              <form action="email_check.jsp" method="post">
                <div class="form-item form-type-textfield form-item-name">
                  <label for="edit-name">Email <span class="form-required" title="This field is required.">* </span></label>
                  <%
                    if(email != null){
                        out.print("<h4 style='border:gray; border-width:3px; border-style:solid;'>"+email+"</h4><br>");
                    }
                    else{
                  %> 
                ...
                <div class="form-actions">
                    ...
                    <div style="float: right">
                        <%
                            if(email != null){
                        %>
                        <button class="w3-button w3-cyan" style="margin-top: 15px"><a href="switch_logout.jsp">Switch as different user</a></button>
                        <%
                            }
                        %>
                    </div>
