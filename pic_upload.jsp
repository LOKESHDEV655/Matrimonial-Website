  ...
  <div class="container">
   ...
   <div class="services">
   	<div class="col-sm-6 login_left">
            <form method="post" action="uploadprocess.jsp?code=<%=code%>" name="uploadForm" enctype="multipart/form-data" >		
                    <table width="25%" height="25%">
                        <tbody>
                            ...
                            <tr><td><input type="submit" value="Upload" style="border: 1px solid black"></td></tr>
                        </tbody>
                    </table>			    
            </form>
	  </div>
