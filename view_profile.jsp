...
<%
        ...
        if(email != null && session.getAttribute(email) != null){
            if(request.getParameter("code").trim().length()==0){
                response.sendRedirect("search_rec.jsp");
            }
            else{
                ...
                try{
                     ...
                     ResultSet rs = st.executeQuery("select * from jeevansathi where code='"+code+"'");
			  ...
			  <table class="table_working_hours">
					...
					<tr class="closed">
						...
						<td class="day_value closed"><span><%=rs.getString("mob")%></span></td>
                            ...
                            <form method="post" action="msg.jsp?code=<%=rs.getString("code")%>">
