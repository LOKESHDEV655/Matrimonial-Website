<%-- 
    ...
    Created on : Aug 2, 2021, 5:38:33 PM
    Author     : lokes
--%>
...
<%
        ...
        if(email==null && session.getAttribute(email)==null){
          response.sendRedirect("profile.jsp?session=1");
        }
        else{
            try{
   ...
   <div class="profile">
   	 <div class="col-md-8 profile_left">
			...
			<div class="col-sm-8 row_1">
						...
						<td class="day_value"><input class="form-control" type="text" name="fname" value="<%=rs.getString("fname")%>" required></td>
					</tr>
                                        <tr class="opened_1">
						<td class="day_label1">Last Name :</td>
						<td class="day_value"><input class="form-control" type="text" name="lname" value="<%=rs.getString("lname")%>" required></td>
					</tr>
                                        <tr class="opened_1">
						...
						<td class="day_value"><input class="form-control" type="date" name="dob" value="<%=rs.getString("dob")%>" required></td>
					</tr>
                                        <tr class="opened">
						    ...
						    <option value="<%=rs.getString("mstatus")%>"><%=rs.getString("mstatus")%></option>
						    ...
						    <option value="<%=rs.getString("mtongue")%>"><%=rs.getString("mtongue")%></option>
						    ...
						    <option value="<%=rs.getString("state")%>"><%=rs.getString("state")%></option>
                                        ...
                                        <tr class="closed">
                                            ...
                                            <td class="day_value closed">
                                                <input class="form-control" type="text" name="occupation" value="<%=rs.getString("occupation")%>" required>
                                            </td>
                                        </tr>
                                        <tr class="closed">
                                            <td class="day_label1">Mobile No :</td>                                            
                                            <td class="day_value closed">
                                                    <input class="form-control" type="text" name="mob" value="<%=rs.getString("mob")%>" required>
                                            </td>                                                
                                        </tr>
                                        ...
                                        <tr class="closed">                                                                                        
                                            <td class="day_value closed" colspan="2">
                                                <input class="form-control btn btn-primary" type="submit" value="Save Profile">                                          </td>                                                
                                        </tr>
