...
<div class="col-md-9 search_left">
  <form method="post" action="search_rec.jsp">	
    <div class="form_but1">
	...
	<div class="col-sm-7 form_radios">
            <input type="checkbox" class="radio_1" name="mstatus" value="Single" /> Single &nbsp;&nbsp;
            <input type="checkbox" class="radio_1" name="mstatus" value="Married" /> Married &nbsp;&nbsp;
            <input type="checkbox" class="radio_1" name="mstatus" value="Divorced" /> Divorced &nbsp;&nbsp;
            <input type="checkbox" class="radio_1" name="mstatus" value="Widowed" /> Widowed &nbsp;&nbsp;		
	</div>
        <div class="clearfix"> </div>
    </div>
